...
posttitle: 'Queue: Linked List Implementation'
...
Click [here](https://github.com/bprsstnt/typescript-algorithms/blob/main/src/data-structures/queue-linked-list/QueueList.ts) to view the entire code of linked list queue written in TypeScript.
