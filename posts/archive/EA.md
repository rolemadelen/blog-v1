...
Click [here](https://github.com/bprsstnt/DataStructures-and-Algorithms/blob/main/src/data-structures/linked-list/LinkedList.ts) to view the entire source code written in TypeScript.
