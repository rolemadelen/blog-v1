...
## TL;DR
vector 구현 소스코드: [midotype/vector](https://github.com/midotype/DataStructures-and-Algorithms/tree/main/01-arrays/vector)
...
설명하기에 앞서 모든 코드에서 코너 케이스 처리 부분은 코드에 포함시키지 않았다. 코너 케이스를 포함한 전체코드는 [깃허브](https://github.com/midotype/DataStructures-and-Algorithms/tree/main/01-arrays/vector)를 참조.
