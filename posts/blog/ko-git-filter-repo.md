---
title: 'GitHub: git-filter-repo'
posttitle: 'GitHub'
postsubtitle: 'git-filter-repo란?'
date: '2022-05-03'
tags:
  - git
  - git-filter-repo
...
```text
Rolemadelen <rolemadelen@pm.me> Madeleine Eu <rolemadelen@pm.me>
...
- [signed commit](./signing-commits/)을 사용하는 경우 해당 작업 종료 후 커밋이 unverified 될 수 있다.
