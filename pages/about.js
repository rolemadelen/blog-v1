    ...
    return (
        <AboutWrapper>
            ...
            <div className='text-primary'>
                <p>
				안녕하세요. Jii Yoo(지이) 입니다. 태고(太鼓)치는 취미를 가지고 있지만 <a href='https://taiko-ch.net/index.php'>태고의 달인</a>은 잘 못합니다. 켄터키주 조용한 곳에 파트너와 강아지 한 마리와 함께 살고 있습니다 👸🏻🐶
                </p>
                <p>
                ...
                <hr />
                <p>
                Greetings, my name is Jii Yoo and I have a hobby of playing Taiko drums (the actual taiko not the <a href='https://www.nintendo.com/store/products/taiko-no-tatsujin-drum-n-fun-switch/'>game</a>). Currently, I reside in a peaceful area of Kentucky with my partner and one furry companion 👸🏻🐶
                </p>
                <p>
