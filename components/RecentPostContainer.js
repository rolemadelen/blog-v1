    ...
    return (
        <SubContainer>
            <div className={"flex justify-between items-center mt-4"}>
                <div className={"py-2 text-xl md:text-2xl font-semibold text-primary"}> {title} </div>
                <NavLink link={link} customClass={`flex justify-end text-sm text-primary`} value={"View more..."} />
            </div>
